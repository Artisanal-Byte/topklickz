...
import { $ as $$Layout, a as $$Header, b as $$Footer } from './Footer_BtNAXVY_.mjs';
...
const $$ServicesGrid = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="
	...
	"> <!-- Top Gradient Line --> <div class="
		...
		"></div> <div class="mx-auto max-w-7xl px-4 lg:px-8 lg:py-16 py-10"> <div class="
				grid
				grid-cols-1
				gap-[5px]
				lg:grid-cols-3
			"> ${services.map((service) => renderTemplate`<a${addAttribute(service.href, "href")} class="
							group
							block
							bg-[#ECECEC]
							p-px
