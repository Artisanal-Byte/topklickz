...
import 'piccolore';
import { m as maybeRenderHead, c as addAttribute, d as renderTemplate, e as renderComponent } from './server_CU52pDLP.mjs';
import { r as renderScript, $ as $$Layout, a as $$Header, b as $$Footer } from './Footer_BtNAXVY_.mjs';
import { c as config } from './keystatic.config_Df-6VW00.mjs';
import { createReader } from '@keystatic/core/reader';
import 'clsx';
import { $ as $$BrandPhilosophy } from './BrandPhilosophy_BQgUc7o6.mjs';
import { $ as $$AboutCtc } from './AboutCtc_CkG4GJSC.mjs';
...
WHO WE ARE
					...
					tracking-normal
					text-[#1d1d1d]
				"> ${descriptions.map((paragraph, index) => renderTemplate`<p${addAttribute(index === 0 ? "m-0" : "mb-0 mt-3 lg:mt-5", "class")}> ${paragraph} </p>`)} </div> </div> </div> <!-- Stats --> <div class="mx-auto max-w-7xl px-6 lg:px-8"> <div class="border-t border-[#d9d9d9]"> <div class="
					grid
					grid-cols-1
					sm:grid-cols-2
					lg:grid-cols-5
