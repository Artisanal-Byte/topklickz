import { A as AstroError, I as InvalidComponentArgs, c as createRenderInstruction, r as renderElement, g as generateCspDigest, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, b as removeBase, i as isRemotePath, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, d as createHeadAndContent, e as renderComponent, f as addAttribute, h as renderHead, j as renderSlot, m as maybeRenderHead } from './prerender_gze0AYe3.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_X29dsbEE.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_Dap0vccC.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BaZcnZ19.mjs');
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": post.data.title }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<h1>${post.data.title}</h1> ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "D:/D Drive/artisanal-byte/topklickz/src/pages/posts/[slug].astro", void 0);

const $$file = "D:/D Drive/artisanal-byte/topklickz/src/pages/posts/[slug].astro";
...
const _slug____astro = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  page
}, Symbol.toStringTag, { value: 'Module' }));

export { DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, _slug____astro as _, renderScriptElement as a, DEFAULT_HASH_PROPS as b, createComponent as c, renderUniqueStylesheet as r };
